...
/// Parse `clouddesktop://` unilinks
///
/// Returns true if we successfully handle the uri provided.
/// [Functions]
/// 1. New Connection: clouddesktop://connection/new/your_peer_id
...
String getWindowName({WindowType? overrideType}) {
  switch (overrideType ?? kWindowType) {
    ...
    case WindowType.FileTransfer:
      return "File Transfer - CloudDesktop";
    case WindowType.PortForward:
      return "Port Forward - CloudDesktop";
    case WindowType.RemoteDesktop:
      return "Remote Desktop - CloudDesktop";
    default:
      break;
  }
  return "CloudDesktop";
