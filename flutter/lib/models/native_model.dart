...
class PlatformFFI {
  ...
  late ClouddesktopImpl _ffiBind;
  ...
  ClouddesktopImpl get ffiBind => _ffiBind;
  ...
  Future<void> init(String appType) async {
    ...
    try {
      ...
      _ffiBind = ClouddesktopImpl(dylib);
      if (Platform.isLinux) {
  ...
  void _startListenEvent(ClouddesktopImpl rustdeskImpl) {
