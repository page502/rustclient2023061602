...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 CloudDesktop 网络..."),
        ("Enable Service", "允许服务"),
        ("Start Service", "启动服务"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 CloudDesktop 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "点击这里更新"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 CloudDesktop \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 CloudDesktop \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允许 CloudDesktop 使用\"无障碍\"服务。"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [CloudDesktop Input] 服务开启。"),
        ...
        ("Quit", "退出"),
        ("doc_mac_permission", "https://clouddesktop.com/docs/zh-cn/manual/mac#%E5%90%AF%E7%94%A8%E6%9D%83%E9%99%90"),
        ("Help", "帮助"),
        ("Failed", "失败"),
        ("Succeeded", "成功"),
        ...
        ("Language", "语言"),
        ("Keep RustDesk background service", "保持 CloudDesktop 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 CloudDesktop 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on Boot", "开机自启动"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 CloudDesktop \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 CloudDesktop \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 CloudDesktop 的 UAC 窗口点击确认。"),
        ...
        ("confirm_idd_driver_tip", "安装虚拟显示器驱动的选项已勾选。请注意，测试证书将被安装以信任虚拟显示器驱动。测试证书仅会用于信任CloudDesktop的驱动。"),
        ("RDP Settings", ""),
        ("Sort by", ""),
        ("New Connection", ""),
        ("Restore", ""),
        ...
        ("verify_rustdesk_password_tip", "验证 CloudDesktop 密码"),
