...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the CloudDesktop network..."),
        ...
        ("install_tip", "Due to UAC, CloudDesktop can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install CloudDesktop to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant CloudDesktop \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant CloudDesktop \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow CloudDesktop to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [CloudDesktop Input] service."),
        ...
        ("doc_mac_permission", "https://clouddesktop.com/docs/en/manual/mac/#enable-permissions"),
        ("doc_fix_wayland", "https://clouddesktop.com/docs/en/manual/linux/#x11-required"),
        ("server_not_support", "Not yet supported by the server"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next CloudDesktop application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant CloudDesktop \"Input Monitoring\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running CloudDesktop."),
        ("config_microphone", "In order to speak remotely, you need to grant CloudDesktop \"Record Audio\" permissions."),
        ...
        ("confirm_idd_driver_tip", "The option to install the virtual display driver is checked. Note that a test certificate will be installed to trust the virtual display driver. This test certificate will only be used to trust CloudDesktop drivers."),
        ...
        ("enter_rustdesk_passwd_tip", "Enter CloudDesktop password"),
        ("remember_rustdesk_passwd_tip", "Remember CloudDesktop password"),
        ("login_linux_tip", "You need to login to remote Linux account to enable a X desktop session"),
        ("verify_rustdesk_password_tip", "Verify CloudDesktop password"),
